var TEMPLATE = (function(){
	...
	var templates = {
		...
		multiple_choice_question: '<div class="form-group quiz-item" data-type="multiple_choice_question"><label>{{question}}</label>{{#each options}}<div class="radio"> <label><input type="radio" name="choice" value="{{title}}">{{title}}</label></div>{{/each}}',
