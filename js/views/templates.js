...
angular.module("../js/views/widgets/my_peer_reviews.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/views/widgets/my_peer_reviews.html",
    ...
    "					<button class=\"btn btn-grey\" type=\"button\" ng-click=\"item.event_handler('click', $index, 1);rate(peer_review, 1)\" style=\"cursor: pointer\"><i  class=\"fa fa-thumbs-up\"></i></button>\n" +
    "					<button class=\"btn btn-grey\" type=\"button\" ng-click=\"item.event_handler('click', $index, -1);rate(peer_review, -1)\" style=\"cursor: pointer; margin-left: 5px;\"><i  class=\"fa fa-thumbs-down\"></i></button>\n" +
    "			</div>\n" +
    "		</div>\n" +
    "	</div>\n" +
    "	</div>\n" +
